    ...
    <div className="w-full overflow-hidden wrapper grid gap-8 justify-items-center items-center align-middle pt-5 pb-12 lg:grid-cols-2 max-sm:flex flex-col justify-center ">
      ...
      <div className="flex w-full min-h-full flex-col mb-50 justify-center px-6 py-12 lg:px-8 ">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="flex w-48 justify-center rounded-full bg-light-pink px-3 py-1.5 text-sm font-semibold leading-6 text-black shadow-sm hover:bg-red-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            &#8594; Continuar sin cuenta*
          </button>
        </div>
        <div className="flex justify-center text-sm  text-left">
          <p className=" text-input-grey text-xs lg:w-80">
