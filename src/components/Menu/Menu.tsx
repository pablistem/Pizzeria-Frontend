...
const Menu = () => {
  ...
  const menuItems = [
    ...
    { icon: orderIcon, label: 'Mis pedidos', section: 'my-order' }, //orders
    { icon: discountIcon, label: 'Descuentos', section: 'discounts' }, //discounts
    { icon: couponIcon, label: 'Cupones', section: 'coupons' }, //coupons
  ];
  return (
